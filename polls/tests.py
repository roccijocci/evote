...
class QuestionModelTest(TestCase):
	...
	def test_was_published_recently_with_old_question(self):
		...
		time = timezone.now() - datetime.timedelta(day=1, seconds=1)
	...
	def create_question(question_text, days):
		...
		#given number of days offset to now(negative for questions publshed
...
class QuestionDetailViewTests(TestCase):
	def test_future_question(self):
		# The detail view of a question with a pub_ddate in the future returns a 404 not test_future_question_and_past_question
